...
The code for the implementation of SSD can be found in [SingleShotDetection.java](https://github.com/awslabs/djl/blob/master/model-zoo/src/main/java/ai/djl/zoo/cv/object_detection/ssd/SingleShotDetection.java).
