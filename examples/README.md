...
Activate the automatic selection by adding `ai.djl.mxnet:mxnet-native-auto:1.7.0-b` for MXNet and `ai.djl.pytorch:pytorch-native-auto:1.6.0` for PyTorh as a dependency.
You can also see:
