...
public final class TrainMobileNetV2WithCifar10 {
    private static final Logger logger = LoggerFactory.getLogger(TrainMobileNetV2WithCifar10.class);

    private TrainMobileNetV2WithCifar10() {}

    public static void main(String[] args) throws ModelException, IOException, TranslateException {
        TrainMobileNetV2WithCifar10.runExample(args);
    }
    ...
    public static TrainingResult runExample(String[] args)
        ...
        try (Model model = getModel(arguments)) {
            ...
            try (Trainer trainer = model.newTrainer(config)) {
                ...
                model.save(modelPath, "mobilenetv2");
    ...
    private static Model getModel(Arguments arguments)
        ...
        if (preTrained) {
            ...
            // construct new MobileNetV2 without pre-trained weights
            Model model = Model.newInstance("mobilenetv2");
            Block mobileNetV2 =
                    MobileNetV2.builder()
                            .setOutSize(10)
                            .build();
            model.setBlock(mobileNetV2);
            return model;
        }
    }
