...
import ai.djl.examples.inference.face.FeatureComparision;
...
public class FeatureComparisionTest {

    @Test
    public void testFeatureComparision() throws ModelException, TranslateException, IOException {
        ...
        Assert.assertTrue(
                Double.compare(FeatureComparision.calculSimilar(feature1, feature2), 0.6) > 0);
    }
}
