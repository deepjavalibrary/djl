...
public class NDArrayOperatorsTest extends AbstractTest {
    ...
    public void testAddScalar() throws FailedTestException {
        ...
        Assertions.assertTrue(!NDArrays.equals(lhs, result), "In-place summation failed");
    ...
    public void testAddNDArray() throws FailedTestException {
        ...
        Assertions.assertTrue(!NDArrays.equals(addend, result), "In-place summation failed");
        NDArray solution = manager.create(new Shape(1, 4), new float[] {3f, 5f, 7f, 9f});
        Assertions.assertEquals(solution, result, "Incorrect value in summed array");

        NDArray[] toAddAll =
                new NDArray[] {
                    manager.create(new Shape(2, 2), new float[] {1, 2, 3, 4}),
                    manager.create(new Shape(2, 2), new float[] {4, 3, 2, 1}),
    ...
    public void testScalarDivision() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 0});
        NDArray result = NDArrays.div(dividend, 3);
        NDArray inPlaceResult = NDArrays.divi(dividend, 3);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {2, 3, 4, 5, 0});
    ...
    public void testElemWiseDivision() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 0});
        NDArray divisor = manager.create(new Shape(1, 5), new float[] {2, 3, 4, 5, 6});
        NDArray result = NDArrays.div(dividend, divisor);
        NDArray inPlaceResult = NDArrays.divi(dividend, divisor);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {3, 3, 3, 3, 0});
        Assertions.assertEquals(
    ...
    public void testReverseScalarDivision() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 45});
        NDArray result = NDArrays.div(180, dividend);
        NDArray inPlaceResult = NDArrays.divi(180, dividend);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {30, 20, 15, 12, 4});
        Assertions.assertEquals(
    ...
    public void testReverseElemWiseDivision() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 45});
        NDArray divisor = manager.create(new Shape(1, 5), new float[] {24, 63, 96, 15, 90});
        NDArray result = dividend.getNDArrayInternal().rdiv(divisor);
        NDArray inPlaceResult = dividend.getNDArrayInternal().rdivi(divisor);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {4, 7, 8, 1, 2});
        Assertions.assertEquals(
                solution,
                result,
    ...
    public void testScalarSubtraction() throws FailedTestException {
        NDArray minuend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 11, 0});
        NDArray result = NDArrays.sub(minuend, 3);
        NDArray inPlaceResult = NDArrays.subi(minuend, 3);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {3, 6, 9, 8, -3});
        Assertions.assertEquals(
    ...
    public void testElemWiseSubtraction() throws FailedTestException {
        NDArray minuend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 0});
        NDArray subtrahend = manager.create(new Shape(1, 5), new float[] {2, 3, 4, 5, 6});
        NDArray result = NDArrays.sub(minuend, subtrahend);
        NDArray inPlaceResult = NDArrays.subi(minuend, subtrahend);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {4, 6, 8, 10, -6});
        Assertions.assertEquals(
    ...
    public void testReverseScalarSubtraction() throws FailedTestException {
        NDArray minuend = manager.create(new Shape(1, 5), new float[] {6, 91, 12, 215, 180});
    ...
    public void testReverseElemWiseSubtraction() throws FailedTestException {
        NDArray minuend = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 45});
        NDArray subtrahend = manager.create(new Shape(1, 5), new float[] {24, 63, 96, 15, 90});
        ...
        NDArray solution = manager.create(new Shape(1, 5), new float[] {18, 54, 84, 0, 45});
        Assertions.assertEquals(
                solution,
                result,
    ...
    public void testScalarMultiplication() throws FailedTestException {
        NDArray multiplicand = manager.create(new Shape(1, 5), new float[] {6, 9, -12, 15, 0});
        NDArray result = NDArrays.mul(multiplicand, 3);
        NDArray inPlaceResult = NDArrays.muli(multiplicand, 3);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {18, 27, -36, 45, 0});
        Assertions.assertEquals(
    ...
    public void testElemWiseMultiplication() throws FailedTestException {
        NDArray multiplicand = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 15, 0});
        NDArray with = manager.create(new Shape(1, 5), new float[] {2, 3, 4, 5, 6});
        NDArray result = NDArrays.mul(multiplicand, with);
        NDArray inPlaceResult = NDArrays.muli(multiplicand, with);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {12, 27, 48, 75, 0});
        Assertions.assertEquals(
        ...
        Assertions.assertTrue(!mulAll.equals(toMulAll[0]), "In-place summation failed");
    ...
    public void testScalarRemainder() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {5, 6, 7, 8, 9});
        NDArray result = NDArrays.mod(dividend, 3);
        NDArray inPlaceResult = NDArrays.modi(dividend, 3);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {2, 0, 1, 2, 0});
        Assertions.assertEquals(
    ...
    public void testElemWiseRemainder() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {7, 8, 9, 10, 11});
        NDArray divisor = manager.create(new Shape(1, 5), new float[] {2, 3, 4, 5, 6});
        NDArray result = NDArrays.mod(dividend, divisor);
        NDArray inPlaceResult = NDArrays.modi(dividend, divisor);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {1, 2, 1, 0, 5});
        Assertions.assertEquals(
    ...
    public void testReverseScalarRemainder() throws FailedTestException {
        ...
        NDArray solution = manager.create(new Shape(1, 5), new float[] {0, 0, 5, 4, 0});
        Assertions.assertEquals(
    ...
    public void testReverseElemWiseRemainder() throws FailedTestException {
        NDArray dividend = manager.create(new Shape(1, 5), new float[] {7, 8, 9, 10, 11});
        NDArray divisor = manager.create(new Shape(1, 5), new float[] {20, 21, 22, 23, 24});
        NDArray result = dividend.getNDArrayInternal().rmod(divisor);
        NDArray inPlaceResult = dividend.getNDArrayInternal().rmodi(divisor);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {6, 5, 4, 3, 2});
        Assertions.assertEquals(
                solution,
                result,
    ...
    public void testNegation() throws FailedTestException {
        NDArray ndArray = manager.create(new Shape(1, 5), new float[] {6, 9, -12, -11, 0});
        NDArray result = ndArray.neg();
        NDArray inPlaceResult = ndArray.negi();
        NDArray solution = manager.create(new Shape(1, 5), new float[] {-6, -9, 12, 11, 0});
        Assertions.assertEquals(
                solution, result, "Scalar subtraction: Incorrect value in result ndarray");
        Assertions.assertEquals(
                solution,
    ...
    public void testMin() throws FailedTestException {
        ...
        NDArray minAxesExpected = manager.create(new Shape(2), new float[] {2, 6});
        Assertions.assertEquals(minAxesExpected, minAxes, "Incorrect min axes");

        NDArray minKeep = original.min(new int[] {0}, true);
        NDArray minKeepExpected = manager.create(new Shape(1, 2), new float[] {2, 4});
    ...
    public void testSum() throws FailedTestException {
        ...
        NDArray sumAxesExpected = manager.create(new Shape(2), new float[] {6, 14});
        Assertions.assertEquals(sumAxesExpected, sumAxes, "Incorrect sum axes");

        NDArray sumKeep = original.sum(new int[] {0}, true);
        NDArray sumKeepExpected = manager.create(new Shape(1, 2), new float[] {8, 12});
    ...
    public void testProd() throws FailedTestException {
        ...
        NDArray prodAxesExpected = manager.create(new Shape(2), new float[] {8, 48});
        Assertions.assertEquals(prodAxesExpected, prodAxes, "Incorrect prod axes");

        NDArray prodKeep = original.prod(new int[] {0}, true);
        NDArray prodKeepExpected = manager.create(new Shape(1, 2), new float[] {12, 32});
    ...
    public void testMean() throws FailedTestException {
        ...
        NDArray meanAxesExpected = manager.create(new Shape(2), new float[] {3, 7});
    ...
    public void testAbs() throws FailedTestException {
        ...
        NDArray expectedND = manager.create(new Shape(testedData.length), testedData);
    ...
    public void testTrunc() throws FailedTestException {
        ...
        NDArray expectedND = manager.create(new Shape(testedData.length), truncData);
    ...
    public void testAsinh() throws FailedTestException {
        ...
        NDArray expectedND = manager.create(new Shape(testedData.length), aSinhData);
    ...
    public void testAtanh() throws FailedTestException {
        ...
        NDArray expectedND = manager.create(new Shape(testedData.length), aTanhData);
    ...
    public void testStack() throws FailedTestException {
        NDArray stackedND = manager.create(new Shape(1), new float[] {1f});
        NDArray stackedND2 = manager.create(new Shape(1), new float[] {2f});
        NDArray actual = manager.create(new Shape(2, 1), new float[] {1f, 2f});
    ...
    public void testPower() throws FailedTestException {
        NDArray array = manager.create(new Shape(1, 5), new float[] {6, 9, 12, 2, 0});
        NDArray power = manager.create(new Shape(1, 5), new float[] {3, 0, 1, -2, 3});
        NDArray result = array.pow(power);
        NDArray inPlaceResult = array.powi(power);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {216, 1, 12, 0.25f, 0});
        Assertions.assertEquals(
    ...
    public void testPowerScalar() throws FailedTestException {
        NDArray array = manager.create(new Shape(1, 5), new float[] {6, 0, -1, 5, 2});
        NDArray result = array.pow(2);
        NDArray inPlaceResult = array.powi(2);
        NDArray solution = manager.create(new Shape(1, 5), new float[] {36, 0, 1, 25, 4});
        Assertions.assertEquals(
                solution, result, "Scalar power: Incorrect value in result ndarray");
        Assertions.assertEquals(
                solution,
    ...
    public void testArgMin() throws FailedTestException {
        ...
        Assertions.assertEquals(argMax, expected, "Argmin: Incorrect value");
