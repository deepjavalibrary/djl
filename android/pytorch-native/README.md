...
`jnilib/0.22.1/android` folder will be created after build, and shared library will be uploaded to S3 in CI build
...
cp -r ../engines/pytorch/pytorch-native/jnilib/0.22.1/android/* pytorch-native/jnilib
