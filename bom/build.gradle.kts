            ...
            pom {
                ...
                withXml {
                    ...
                    dependencies.apply {
                        ...
                        +"ai.djl.pytorch:pytorch-native-cpu:$pytorch:linux-aarch64"
                        +"ai.djl.pytorch:pytorch-native-cu128:$pytorch:linux-x86_64"
                        +"ai.djl.pytorch:pytorch-native-cu128:$pytorch:win-x86_64"
                        pytorch = "2.5.1"
                        +"ai.djl.pytorch:pytorch-native-cpu:$pytorch:osx-aarch64"
                        +"ai.djl.pytorch:pytorch-native-cpu:$pytorch:linux-x86_64"
                        +"ai.djl.pytorch:pytorch-native-cpu:$pytorch:win-x86_64"
                        ...
                        +"ai.djl.pytorch:pytorch-native-cu124:$pytorch:linux-x86_64"
                        +"ai.djl.pytorch:pytorch-native-cu124:$pytorch:win-x86_64"
                        pytorch = "1.13.1"
