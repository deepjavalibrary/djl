...
public final class JniUtils {
    ...
    public static PtNDArray createNdFromByteBuffer(
        ...
        if (layout == 1 || layout == 2 || device.isGpu()) {
            ...
            return PtNDArrayImpl.newPtNDArray(manager, handle);
        }
        return PtNDArrayImpl.newPtNDArray(manager, handle, data);
    }
    ...
    public static PtNDArray indexAdv(PtNDArray ndArray, NDIndex index, PtNDManager manager) {
        ...
        try {
            ...
            return PtNDArrayImpl.newPtNDArray(manager, ret);
        } finally {
    ...
    public static PtNDArray stack(PtNDArray[] arrays, int dim) {
        ...
        return PtNDArrayImpl.newPtNDArray(
                arrays[0].getManager(), PyTorchLibrary.LIB.torchStack(pointers, dim));
    }
    ...
    public static NDList split(PtNDArray ndArray, long size, long axis) {
        ...
        for (long ptr : ndPtrs) {
            list.add(PtNDArrayImpl.newPtNDArray(ndArray.getManager(), ptr));
        }
        return list;
    }
    ...
    public static NDList rnn(
        ...
        for (long output : outputs) {
            res.add(PtNDArrayImpl.newPtNDArray(manager, output));
        }
        return res;
    }
    ...
    public static PtNDArray getGradient(PtNDArray ndArray) {
        ...
        return PtNDArrayImpl.newPtNDArray(ndArray.getManager(), pointer);
    }
    ...
    public static NDList moduleGetParams(PtSymbolBlock block, PtNDManager manager) {
        ...
        for (int i = 0; i < handles.length; i++) {
            PtNDArray array = PtNDArrayImpl.newPtNDArray(manager, handles[i]);
