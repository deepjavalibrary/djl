...
- Change the "Use following expression" field to something like [toDebugString(100, 10, 10, 20)](https://javadoc.djl.ai/api/0.4.0/ai/djl/ndarray/NDArray.html#toDebugString-ai.djl.ndarray.NDArray-int-int-int-int-)
