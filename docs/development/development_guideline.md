...
- Change the "Use following expression" field to something like [toDebugString(100, 10, 10, 20)](https://javadoc.io/static/ai.djl/api/0.15.0/ai/djl/ndarray/NDArray.html#toDebugString-int-int-int-int-)
