...
You can use [ModelZoo.listModels()](https://javadoc.io/static/ai.djl/api/0.34.0/ai/djl/repository/zoo/ModelZoo.html#listModels--) API to query available models.
