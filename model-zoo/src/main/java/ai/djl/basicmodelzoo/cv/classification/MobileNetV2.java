    ...
    public static Block mobilenetV2(Builder builder) {
        ...
        Block bottleNeck1 =
                makeStage(
                        ...
                        builder.filters[1],
                        builder.strides[1],
                        builder.multiTimes[0],
                        builder.batchNormMomentum);
        Block bottleNeck2 =
                makeStage(
                        builder.repeatTimes[2],
                        builder.filters[1],
                        builder.filters[2],
                        builder.strides[2],
                        builder.multiTimes[1],
                        builder.batchNormMomentum);
        Block bottleNeck3 =
                makeStage(
                        builder.repeatTimes[3],
                        builder.filters[2],
                        builder.filters[3],
                        builder.strides[3],
                        builder.multiTimes[2],
                        builder.batchNormMomentum);
        Block bottleNeck4 =
                makeStage(
                        builder.repeatTimes[4],
                        builder.filters[3],
                        builder.filters[4],
                        builder.strides[4],
                        builder.multiTimes[3],
                        builder.batchNormMomentum);
        Block bottleNeck5 =
                makeStage(
                        builder.repeatTimes[5],
                        builder.filters[4],
                        builder.filters[5],
                        builder.strides[5],
                        builder.multiTimes[4],
                        builder.batchNormMomentum);
        Block bottleNeck6 =
                makeStage(
                        builder.repeatTimes[6],
                        builder.filters[5],
                        builder.filters[6],
                        builder.strides[6],
                        builder.multiTimes[5],
                        builder.batchNormMomentum);
        Block bottleNeck7 =
                makeStage(
                        builder.repeatTimes[7],
                        builder.filters[6],
                        builder.filters[7],
                        builder.strides[7],
                        builder.multiTimes[6],
                        builder.batchNormMomentum);
                                                        ...
                                                        .reshape(
                                                                new Shape(
                                                                        list.get(0)
                                                                                .getShape()
                                                                                .get(0),
                                                                        builder.outSize))))); // reshape for output
    }
