...
/** DeviceType is the PaddlePaddle equivalent of the types in {@link Device}. */
public final class PpDeviceType implements DeviceType {

    private static final String CPU_PINNED = "cpu_pinned";

    private PpDeviceType() {
    }

    /**
     * Converts a {@link Device} to the corresponding PaddlePaddle device number.
     *
     * @param device the java {@link Device}
     * @return the PaddlePaddle device number
     */
    ...
    /**
     * Converts from an PaddlePaddle device number to {@link Device}.
     *
     * @param deviceType the PaddlePaddle device number
