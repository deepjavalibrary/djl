...
You can download djl-bench zip file from [here](https://publish.djl.ai/djl-bench/0.13.0/benchmark-0.12.0.zip).

```
curl -O https://publish.djl.ai/djl-bench/0.13.0/benchmark-0.12.0.zip
