...
import ai.djl.gluonTS.translator.DeepARTranslator;
...
public final class DeepARExample {

    private static final Logger logger = LoggerFactory.getLogger(DeepARExample.class);

    private DeepARExample() {}

    public static void main(String[] args) throws IOException, TranslateException, ModelException {
        logger.info(Engine.getInstance().getVersion());
        float[] results = DeepARExample.predict(args);
    }
