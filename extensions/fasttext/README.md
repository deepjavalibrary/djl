...
class. You can find examples [here](https://github.com/awslabs/djl/blob/master/extensions/fasttext/src/test/java/ai/djl/fasttext/CookingStackExchangeTest.java).
