 ...
 * href="https://arxiv.org/pdf/1804.02767.pdf">DarkNet</a>.
 *
 * @see ai.djl.mxnet.engine.MxSymbolBlock
 */
public class Darknet extends ImageClassificationModelLoader {

    private static final String ARTIFACT_ID = "darknet";
     ...
     */
    public Darknet(Repository repository) {
