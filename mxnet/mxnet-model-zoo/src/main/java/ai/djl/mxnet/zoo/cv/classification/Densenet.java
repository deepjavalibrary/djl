 ...
 * href="https://arxiv.org/pdf/1512.03385.pdf">DenseNet</a>.
 *
 * @see ai.djl.mxnet.engine.MxSymbolBlock
 */
public class Densenet extends ImageClassificationModelLoader {

    private static final String ARTIFACT_ID = "densenet";
     ...
     */
    public Densenet(Repository repository) {
