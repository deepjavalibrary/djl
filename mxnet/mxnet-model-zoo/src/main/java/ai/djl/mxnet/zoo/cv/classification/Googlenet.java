 ...
 * href="https://arxiv.org/pdf/1409.4842.pdf">GoogLeNet</a>.
 *
 * @see ai.djl.mxnet.engine.MxSymbolBlock
 */
public class Googlenet extends ImageClassificationModelLoader {

    private static final String ARTIFACT_ID = "googlenet";
     ...
     */
    public Googlenet(Repository repository) {
