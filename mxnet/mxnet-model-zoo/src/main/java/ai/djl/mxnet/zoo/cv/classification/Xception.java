 ...
 * href="https://arxiv.org/pdf/1512.00567.pdf">Xception</a>.
 *
 * @see ai.djl.mxnet.engine.MxSymbolBlock
 */
public class Xception extends ImageClassificationModelLoader {

    private static final String ARTIFACT_ID = "xception";
     ...
     */
    public Xception(Repository repository) {
