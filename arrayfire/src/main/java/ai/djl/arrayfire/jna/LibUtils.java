...
/**
 * Utilities for finding the ArrayFire Engine binary on the System.
 *
...
public final class LibUtils {
    ...
    private static final String LIB_NAME = "af";

    private LibUtils() {}

    static ArrayFireLibrary loadLibrary() {
        String libName = getLibName();
        logger.debug("Loading paddle library from: {}", libName);

        return Native.load(libName, ArrayFireLibrary.class);
    }
    ...
    private static String findOverrideLibrary() {
        String libPath = System.getenv("AF_LIBRARY_PATH");
        if (libPath != null) {
