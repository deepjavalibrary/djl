...
public class ModelFactory {
    ...
    public static Model loadModel(String modelPath, int epoch) {
        File file = new File(modelPath);
        String modelName = file.getName();
        return loadModel(file, modelName, -1);
    }

    public static Model loadModel(File modelPath) {
        return loadModel(modelPath, modelPath.getName(), -1);
    }

    public static Model loadModel(File modelPath, String modelName) {
        return loadModel(modelPath, modelPath.getName(), -1);
    }

    public static Model loadModel(File modelPath, String modelName, int epoch) {
