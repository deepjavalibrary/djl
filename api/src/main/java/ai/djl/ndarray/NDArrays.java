...
public final class NDArrays {
     ...
     * <pre>
     * jshell&gt; NDArray array = manager.create(new float[] {-3f, -4f});
     * jshell&gt; NDArrays.norm(array, new int[] {0});
     * ND: () cpu() float32
     * 5.
     * jshell&gt; NDArray array = manager.create(new float[] {1f, 2f, 3f, 4f}, new Shape(2, 2));
     * jshell&gt; NDArrays.norm(array, new int[] {0});
     ...
     * <pre>
     * jshell&gt; NDArray array = manager.create(new float[] {-3f, -4f});
     * jshell&gt; NDArrays.norm(array, true);
     * ND: () cpu() float32
     * 5.
     * jshell&gt; NDArray array = manager.create(new float[] {1f, 2f, 3f, 4f}, new Shape(2, 2));
     * jshell&gt; NDArrays.norm(array, true);
     ...
     * <pre>
     * jshell&gt; NDArray array = manager.create(new float[] {1f, 2f, 3f, 4f}, new Shape(2, 2));
     * jshell&gt; NDArrays.norm(new int[] {0}, true);
     * ND: (1, 2) cpu() float32
     * [[3.1623, 4.4721],
     * ]
     * jshell&gt; NDArray array = manager.create(new float[] {1f, 2f, 3f, 4f}, new Shape(2, 2));
     * jshell&gt; NDArrays.norm(new int[] {0}, false);
     * ND: (2) cpu() float32
     * [3.1623, 4.4721]
     * </pre>
     *
