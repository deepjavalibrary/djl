...
public class YoloTranslatorFactoryTest {

    private YoloTranslatorFactory factory;

    @BeforeClass
    public void setUp() {
        factory = new YoloTranslatorFactory();
    }
    ...
    public void testNewInstance() {
        ...
        try (Model model = Model.newInstance("test")) {
            ...
            Assert.assertTrue(translator1 instanceof YoloTranslator);
