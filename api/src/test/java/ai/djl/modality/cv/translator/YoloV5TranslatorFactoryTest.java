...
public class YoloV5TranslatorFactoryTest {

    private YoloV5TranslatorFactory factory;

    @BeforeClass
    public void setUp() {
        factory = new YoloV5TranslatorFactory();
    }
    ...
    public void testNewInstance() {
        ...
        try (Model model = Model.newInstance("test")) {
            ...
            Assert.assertTrue(translator1 instanceof YoloV5Translator);
