...
public class InstanceSegmentationTranslatorFactoryTest {

    private InstanceSegmentationTranslatorFactory factory;

    @BeforeClass
    public void setUp() {
        factory = new InstanceSegmentationTranslatorFactory();
    }
    ...
    public void testNewInstance() {
        ...
        try (Model model = Model.newInstance("test")) {
            ...
            Assert.assertTrue(translator1 instanceof InstanceSegmentationTranslator);
