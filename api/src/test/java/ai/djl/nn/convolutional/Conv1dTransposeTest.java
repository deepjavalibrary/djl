...
public class Conv1dTransposeTest extends OutputShapeTest {
    ...
    public void testOutputShapes() {
        ...
        Range outputPaddingWidthRange = Range.ofClosed(0, 5);
        ...
        streamToTest
                ...
                .peek(
                        td -> {
                            ...
                            td.setFilters(option.getKey().intValue() * 32);
                            ix = option.getValue();

                            option = Range.toValue(ix, widths);
                            td.setWidth(option.getKey().intValue() * 32);
                            ix = option.getValue();
                            ...
                            shaped = Range.toShape(ix, outputPaddingWidthRange);
                            td.setOutputPadding(shaped.getKey());
                            ix = shaped.getValue();
