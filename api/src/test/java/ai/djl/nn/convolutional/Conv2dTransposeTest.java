...
public class Conv2dTransposeTest extends OutputShapeTest {
    ...
    public void testOutputShapes() {
        ...
        Range outputPaddingHeightRange = Range.ofClosed(0, 3);
        Range outputPaddingWidthRange = Range.ofClosed(0, 3);
        ...
        streamToTest
                ...
                .peek(
                        td -> {
                            ...
                            shaped =
                                    Range.toShape(
                                            ix, outputPaddingHeightRange, outputPaddingWidthRange);
