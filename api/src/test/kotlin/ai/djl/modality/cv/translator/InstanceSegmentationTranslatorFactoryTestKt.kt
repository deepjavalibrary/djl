...
class InstanceSegmentationTranslatorFactoryTestKt {
    private lateinit var factory: InstanceSegmentationTranslatorFactory
    ...
    @Test fun testNewInstance() {
        ...
        Model.newInstance("test").use { model ->
            ...
            Assert.assertTrue(translator1 is InstanceSegmentationTranslator)
