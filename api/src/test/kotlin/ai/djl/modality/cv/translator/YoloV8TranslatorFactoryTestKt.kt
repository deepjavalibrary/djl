...
class YoloV8TranslatorFactoryTestKt {
    private lateinit var factory: YoloV8TranslatorFactory

    @BeforeClass
    fun setUp() {
        factory = YoloV8TranslatorFactory()
    }
    ...
    fun testNewInstance() {
        ...
        Model.newInstance("test").use { model ->
            ...
            Assert.assertTrue(translator1 is YoloV8Translator)
