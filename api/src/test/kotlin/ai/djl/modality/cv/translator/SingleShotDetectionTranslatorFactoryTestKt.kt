...
class SingleShotDetectionTranslatorFactoryTestKt {
    private lateinit var factory: SingleShotDetectionTranslatorFactory

    @BeforeClass
    fun setUp() {
        factory = SingleShotDetectionTranslatorFactory()
    }
    ...
    fun testNewInstance() {
        ...
        Model.newInstance("test").use { model ->
            ...
            Assert.assertTrue(translator1 is SingleShotDetectionTranslator)
