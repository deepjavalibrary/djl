...
class YoloV5TranslatorFactoryTestKt {
    private lateinit var factory: YoloV5TranslatorFactory

    @BeforeClass
    fun setUp() {
        factory = YoloV5TranslatorFactory()
    }
    ...
    fun testNewInstance() {
        ...
        Model.newInstance("test").use { model ->
            ...
            Assert.assertTrue(translator1 is YoloV5Translator)
